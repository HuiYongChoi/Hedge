...
export const translations = {
  ko: {
    ...
    pcpFwdHelp: 'Forward는 다음 회계연도 추정치입니다. FwdPER은 현재가 대비 다음 연도 EPS 기준 배수입니다.',
  ...
  en: {
    ...
    pcpFwdHelp: 'Forward uses next fiscal-year estimates. Fwd P/E is current price divided by next-year EPS.',
