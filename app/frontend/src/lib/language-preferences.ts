...
export const translations = {
  ko: {
    ...
    activeTicker: '활성 종목',
    agentsSelected: '선택된 에이전트',
    period: '기간',
    workspaceModel: '워크스페이스 모델',
    workspaceSync: '워크스페이스 동기화',
    workspaceSyncOn: '동기화 켜짐',
    workspaceSyncOff: '동기화 꺼짐',
    noTickerSelected: '종목 미선택',
    noAgentsSelected: '에이전트 미선택',
    selectAgentsInStockSearch: '에이전트 선택은 종목 분석 탭에서 할 수 있습니다.',
    customRange: '직접 지정',
  ...
  en: {
    ...
    noAgentsSelected: 'No agents',
    selectAgentsInStockSearch: 'Choose agents from the Stock Analysis tab.',
    customRange: 'Custom',
