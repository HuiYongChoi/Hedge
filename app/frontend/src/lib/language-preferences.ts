...
export const translations = {
  ko: {
    ...
    marginOfSafetyHelp: '안전마진은 보고서의 구조화 안전마진을 우선 사용합니다. 없으면 본문에 적힌 margin_of_safety/안전마진 값을 추출하고, 그래도 없을 때 내재가치와 현재가로 계산합니다.',
  ...
  en: {
    ...
    marginOfSafetyHelp: 'Margin of safety first uses a structured report value. If missing, it extracts margin_of_safety / safety-margin text from the report body, then falls back to intrinsic value versus current price.',
