...
export const agentFormulas: Record<string, AgentFormula> = {
  ...
  'Valuation Analyst': {
    ...
    axes: [
      { nameKo: '현금흐름 시나리오 (DCF)', nameEn: 'DCF scenarios', maxScore: '기본 24% / CapEx-heavy 16%', formulaKo: '기본·약세·강세 시나리오의 잉여현금흐름을 WACC로 할인해 기대 가치를 계산합니다.', formulaEn: 'Discounts bear, base, and bull free-cash-flow scenarios at WACC to estimate expected value.' },
      { nameKo: '진짜 주머니 현금 (Owner Earnings)', nameEn: 'Owner Earnings', maxScore: '기본 24% / CapEx-heavy 20%', formulaKo: '순이익에 감가상각을 더하고 유지보수 투자와 운전자본 변동을 차감해 주주에게 남는 현금을 계산합니다.', formulaEn: 'Adds depreciation to net income, subtracts maintenance investment and working-capital change, then values the cash left for owners.' },
    ...
    dcf: {
      ...
      titleEn: 'Valuation Analyst v10.3 Scenario Approach',
      stepsKo: [
