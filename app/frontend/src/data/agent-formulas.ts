...
export const agentFormulas: Record<string, AgentFormula> = {
  ...
  'Valuation Analyst': {
    ...
    axes: [
      { nameKo: '현금흐름 시나리오 (DCF)', nameEn: 'DCF scenarios', maxScore: '기본 23% / CapEx-heavy 15%', formulaKo: '기본·약세·강세 시나리오의 잉여현금흐름을 WACC로 할인해 기대 가치를 계산합니다.', formulaEn: 'Discounts bear, base, and bull free-cash-flow scenarios at WACC to estimate expected value.' },
      { nameKo: '진짜 주머니 현금 (Owner Earnings)', nameEn: 'Owner Earnings', maxScore: '기본 22% / CapEx-heavy 18%', formulaKo: '순이익에 감가상각을 더하고 유지보수 투자와 운전자본 변동을 차감해 주주에게 남는 현금을 계산합니다.', formulaEn: 'Adds depreciation to net income, subtracts maintenance investment and working-capital change, then values the cash left for owners.' },
      { nameKo: '현재 시장 멀티플 (EV/EBITDA)', nameEn: 'EV/EBITDA', maxScore: '기본 9% / CapEx-heavy 12%', formulaKo: '현재 EBITDA와 과거 EV/EBITDA 중앙값 또는 CapEx-heavy 75백분위 멀티플을 비교합니다.', formulaEn: 'Compares current EBITDA with the historical median EV/EBITDA multiple or the capex-heavy 75th percentile.' },
      { nameKo: '보수적 멀티플 (EV/EBIT)', nameEn: 'EV/EBIT', maxScore: '기본 8% / CapEx-heavy 10%', formulaKo: '감가상각을 실제 비용으로 반영한 EV/EBIT(영업이익) 멀티플로, EV/EBITDA보다 보수적이라 자본집약·사이클 종목을 교차검증합니다. 영업이익이 적자면 제외됩니다.', formulaEn: 'Uses the EV/EBIT (operating income) multiple, which charges depreciation as a real cost — more conservative than EV/EBITDA for capital-intensive and cyclical names. Skipped when operating income is negative.' },
      ...
      { nameKo: '장부가치 보정 (Residual Income / PBR)', nameEn: 'Residual Income / PBR', maxScore: 'RIM 7~15% + PBR Band 10~11%', formulaKo: 'Residual Income은 장부가치 위 초과이익을 할인하고, PBR Band는 과거 PBR 분포의 적정 가격대를 보여줍니다.', formulaEn: 'Residual Income discounts excess earnings above book value, while PBR Band maps the stock against historical P/B ranges.' },
      { nameKo: '현금흐름 인사이트 (FCFF · FCFE)', nameEn: 'Cash-flow insight (FCFF · FCFE)', maxScore: '참고 지표 · 가중치 없음', formulaKo: 'FCFF/EV와 FCFE 수익률로 저평가가 진짜인지(밸류트랩)와 배당·자사주 등 주주 환원 여력을 보여주는 독립 인사이트입니다. 가중 평균에는 포함되지 않습니다.', formulaEn: 'An independent insight: FCFF/EV and FCFE yields flag whether cheapness is genuine (value-trap check) and how much capacity exists for dividends and buybacks. Not part of the weighted blend.' },
    ],
    dcf: {
      titleKo: '밸류에이션 모델 - v11.1 실전 시나리오',
      titleEn: 'Valuation Analyst v11.1 Scenario Approach',
      stepsKo: [
        '이 회사가 돈을 빌릴 수 있는 이자와 주주들이 원하는 수익률을 합쳐 평가 기준 허들을 만듭니다 (WACC).',
        'DCF와 Owner Earnings로 현금흐름 기반 내재가치를 계산하고, EV/EBITDA·EV/EBIT와 Normalized EBITDA로 수익력 멀티플을 교차검증합니다.',
        'ROIC−WACC EVA로 투하자본이 가치를 만드는지, PBR Band로 장부가치 기준 가격대를 확인하고, FCFF·FCFE 현금흐름 인사이트로 저평가의 진위와 주주 환원 여력을 점검합니다.',
        '일반 기업은 DCF 23%, Owner Earnings 22%, EV/EBITDA 9%, EV/EBIT 8%, RIM 7%, PBR Band 11%, EBITDA 정규화 10%, ROIC−WACC EVA 10%로 가중합니다.',
        'CapEx-heavy 기업은 DCF 15%, Owner Earnings 18%, EV/EBITDA 12%, EV/EBIT 10%, RIM 15%, PBR Band 10%, EBITDA 정규화 10%, ROIC−WACC EVA 10%로 가중합니다.',
        '혼합 내재 가치가 주식 가격보다 15% 이상 높으면 Buy, 15% 이상 낮으면 Sell 성향입니다.'
      ],
      stepsEn: [
        'Find the cost of capital based on debt and equity (WACC).',
        'Use DCF and Owner Earnings for cash-flow intrinsic value, then cross-check earnings power with EV/EBITDA, EV/EBIT, and Normalized EBITDA.',
        'Use ROIC−WACC EVA to test whether invested capital creates value, check book-value ranges with PBR Band, and read the FCFF/FCFE cash-flow insight for value-trap and shareholder-return signals.',
        'Default weighting is DCF 23%, Owner Earnings 22%, EV/EBITDA 9%, EV/EBIT 8%, RIM 7%, PBR Band 11%, Normalized EBITDA 10%, and ROIC−WACC EVA 10%.',
        'CapEx-heavy weighting is DCF 15%, Owner Earnings 18%, EV/EBITDA 12%, EV/EBIT 10%, RIM 15%, PBR Band 10%, Normalized EBITDA 10%, and ROIC−WACC EVA 10%.',
