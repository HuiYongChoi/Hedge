          ...
          return (
            ...
            >
              ...
              <div className="mt-1 flex items-baseline justify-between gap-1">
                ...
                {upside !== null && (
                  <span className={`font-mono text-[10px] ${upsideClass(upside)}`}>
                    {formatPct(upside)}
                  </span>
                )}
              ...
              {/* Row 3: days ago */}
              <div className={`mt-0.5 font-mono text-[9px] ${isStale ? 'text-muted-foreground/40' : 'text-muted-foreground/60'}`}>
