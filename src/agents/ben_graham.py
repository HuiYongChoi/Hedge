...
def generate_graham_output(
    ...
    template = ChatPromptTemplate.from_messages(
        [
            ...
            6. Preserve decimal points in current ratio and similar ratios, but render debt_to_equity in user-facing Korean as 이자부채비율 11% like a clean percentage.
            ...
            - debt_to_equity is a user-facing percentage in Korean output: render it as 이자부채비율 11% style without 'x' or extra explanation.
            ...
            - In Korean output, important formula terms must be Korean first with English in parentheses: 그레이엄 넘버 (Graham Number), 안전마진 (margin of safety), 유동비율 (current ratio). For debt-to-equity, keep the visible label short as 이자부채비율 11%.
